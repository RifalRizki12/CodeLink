...
public class EmployeeRepository : GeneralRepository<Employee, Guid>, IEmployeeRepository
{
    ...
    public async Task<ResponseOKHandler<UpdateClientDto>> UpdateClient(Guid companyGuid, UpdateClientDto clientDto)
    {
        try
        {
            using (var content = new MultipartFormDataContent())
            {
                ...
                string requestUrl = "updateClient/" + companyGuid; // Sesuaikan dengan URL endpoint yang benar
